...
word_better_counter = python_philosophy.count('better')
word_never_counter = python_philosophy.count('never')
word_is_counter = python_philosophy.count('is')

uppercase_text = python_philosophy.upper()

replaced_text = python_philosophy.replace('i','&')

print("Number of occurrences of the word 'better':", word_better_counter)
print("Number of occurrences of the word 'never':", word_never_counter)
print("Number of occurrences of the word 'is':", word_is_counter)

print("Changed all text to uppercase:", uppercase_text)

print("Changed symboll “i” with “&” in whole text:", replaced_text)
