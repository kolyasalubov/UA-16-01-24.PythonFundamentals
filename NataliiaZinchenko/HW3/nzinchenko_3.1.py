...
print(f"Word 'is' occurred {counter_is} times.")
print("=====================================")


# 1.2 Displaying all text in uppercase
zen_of_python_uppercase = zen_of_python.upper()
print(zen_of_python_uppercase)
print("=====================================")


# 1.3 Replacing "i" with "&"
zen_with_replaced_and = zen_of_python.replace("and", "&")
print(zen_with_replaced_and)
print("=====================================")
